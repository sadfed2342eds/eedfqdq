...
|-----:|----------:|--------|------|-----------------|
| 1 | 0 | BTC | Bitcoin | `m/84'/0'/0'/0/%d  (BIP-84 SegWit) \| m/44'/0'/0'/0/%d (legacy) \| m/49'/0'/0'/0/%d (segwit-compat) \| m/86'/0'/0'/0/%d (taproot)` |
| 2 | 60 | ETH | Ether | `m/44'/60'/0'/0/%d` |
| 3 | 144 | XRP | XRP | `m/44'/144'/0'/0/%d` |
| 4 | 714 | BNB | Binance | `m/44'/714'/0'/0/%d` |
| 5 | 501 | SOL | Solana | `m/44'/501'/%d'/0'` |
| 6 | 3 | DOGE | Dogecoin | `m/44'/3'/0'/0/%d` |
| 7 | 195 | TRX | Tron | `m/44'/195'/0'/0/%d` |
| 8 | 1815 | ADA | Cardano | `m/1852'/1815'/%d'/0/0` |
| 9 | 607 | TON | TON | `m/44'/607'/%d'` |
| 10 | 9000 | AVAX | Avalanche | `m/44'/9000'/0'/0/%d` |
| 13 | 354 | DOT | Polkadot | `m/44'/354'/0'/0'/%d'` |
| 14 | 145 | BCH | Bitcoin Cash | `m/44'/145'/0'/0/%d` |
| 15 | 2 | LTC | Litecoin | `m/84'/2'/0'/0/%d  (BIP-84 SegWit) \| m/44'/2'/0'/0/%d (legacy) \| m/49'/2'/0'/0/%d (segwit-compat)` |
| 16 | 148 | XLM | Stellar Lumens | `m/44'/148'/%d'` |
| 17 | 397 | NEAR | NEAR Protocol | `m/44'/397'/0'` |
| 18 | 223 | ICP | Internet Computer (DFINITY) | `m/44'/223'/0'/0/%d` |
| 20 | 637 | APTOS | Aptos | `m/44'/637'/%d'/0'/0'` |
| 21 | 784 | SUI | Sui | `m/44'/784'/%d'/0'/0'` |
| 22 | 3030 | HBAR | Hedera HBAR | `m/44'/3030'/0'/0'/%d'` |
| 24 | 61 | ETC | Ether Classic | `m/44'/61'/0'/0/%d` |
| 25 | 111111 | KAS | Kaspa | `m/44'/111111'/0'/0/%d` |
| 27 | 128 | XMR | Monero | `m/44'/128'/0'/0/%d` |
| 28 | 461 | FIL | Filecoin | `m/44'/461'/0'/0/%d` |
| 29 | 118 | ATOM | Atom | `m/44'/118'/0'/0/%d` |
| 30 | 394 | CRO | Crypto Chain | `m/44'/394'/0'/0/%d` |
| 32 | 818 | VET | VeChain Token | `m/44'/818'/0'/0/%d` |
| 34 | 283 | ALGO | Algorand | `m/44'/283'/%d'/0'/0'` |
| 35 | 931 | RUNE | THORChain (RUNE) | `m/44'/931'/0'/0/%d` |
| 36 | 22000119 | INJ | Injective | `m/44'/22000119'/0'/0/%d` |
| 40 | 966 | MATIC | Matic | `m/44'/966'/0'/0/%d` |
| 42 | 5757 | STX | Stacks | `m/44'/5757'/0'/0/%d` |
| 44 | 558 | TAO | Tao | `m/44'/558'/0'/0/%d` |
| 47 | 133 | ZEC | Zcash | `m/44'/133'/0'/0/%d` |
| 49 | 500 | THETA | Theta | `m/44'/500'/0'/0/%d` |
| 50 | 508 | EGLD | MultiversX | `m/44'/508'/0'/0'/%d'` |
| 51 | 1729 | XTZ | Tezos | `m/44'/1729'/%d'/0'` |
| 54 | 888 | NEO | NEO | `m/44'/888'/0'/0/%d` |
| 55 | 270 | ONE | ONE | `m/44'/270'/0'/0/%d` |
| 56 | 626 | KDA | Kadena | `m/44'/626'/0'/0/%d` |
| 60 | 474 | ROSE | Oasis Network | `m/44'/474'/0'/0/%d` |
| 64 | 12586 | MINA | Mina | `m/44'/12586'/%d'/0/0` |
| 65 | 5 | DASH | Dash | `m/44'/5'/0'/0/%d` |
| 66 | 4218 | IOTA | IOTA | `m/44'/4218'/%d'/0'/0'` |
| 67 | 4219 | SMR | Shimmer | `m/44'/4219'/%d'/0'/0'` |
| 68 | 194 | EOS | EOS | `m/44'/194'/0'/0/%d` |
| 70 | 1024 | ONT | Ontology | `m/44'/1024'/0'/0/%d` |
| 71 | 74 | ICX | ICON | `m/44'/74'/0'/0/%d` |
| 72 | 459 | KAVA | Kava | `m/44'/459'/0'/0/%d` |
| 74 | 1155 | ENJ | Enjin Coin | `m/44'/1155'/0'/0/%d` |
| 77 | 5741564 | WAVES | Waves | `m/44'/5741564'/0'/0/%d` |
| 78 | 175 | RVN | Ravencoin | `m/44'/175'/0'/0/%d` |
| 79 | 236 | BSV | BitcoinSV | `m/44'/236'/0'/0/%d` |
| 80 | 156 | BTG | Bitcoin Gold | `m/44'/156'/0'/0/%d` |
| 82 | 2301 | QTUM | QTUM | `m/44'/2301'/0'/0/%d` |
| 85 | 42 | DCR | Decred | `m/44'/42'/0'/0/%d` |
| 86 | 165 | XNO | Nano | `m/44'/165'/0'/0/%d` |
| 87 | 19000118 | SEI | SEI | `m/44'/19000118'/0'/0/%d` |
| 88 | 539 | FLOW | Flow | `m/44'/539'/0'/0/%d` |
| 90 | 434 | KSM | Kusama | `m/44'/434'/0'/0'/%d'` |
| 91 | 309 | CKB | Nervos CKB | `m/44'/309'/0'/0/%d` |
| 92 | 472 | AR | Arweave | `m/44'/472'/0'/0/%d` |
| 94 | 9004 | STRK | StarkNet | `m/44'/9004'/0'/0/%d` |
| 95 | 130822 | WBT | WhiteBIT Coin | `m/44'/130822'/0'/0/%d` |
| 97 | 3434 | PEPE | Pepecoin Core | `m/44'/3434'/0'/0/%d` |
| 103 | 494 | BAND | Band | `m/44'/494'/0'/0/%d` |
| 105 | 52752 | CELO | Celo | `m/44'/52752'/0'/0/%d` |
| 106 | 904 | HNT | Helium | `m/44'/904'/0'/0/%d` |
| 107 | 304 | IOTX | IoTeX | `m/44'/304'/0'/0/%d` |
| 110 | 121 | ZEN | Zencash | `m/44'/121'/0'/0/%d` |
| 115 | 482 | OCEAN | Ocean Protocol | `m/44'/482'/0'/0/%d` |
| 121 | 577 | NKN | NKN | `m/44'/577'/0'/0/%d` |
| 122 | 3333 | SXP | Solar | `m/44'/3333'/0'/0/%d` |
| 126 | 1991 | SC | Sia | `m/44'/1991'/0'/0/%d` |
| 127 | 20 | DGB | DigiByte | `m/44'/20'/0'/0/%d` |
| 128 | 313 | ZIL | Zilliqa | `m/44'/313'/0'/0/%d` |
| 129 | 134 | LSK | Lisk | `m/44'/134'/0'/0/%d` |
| 130 | 77 | XVG | Verge Currency | `m/44'/77'/0'/0/%d` |
| 131 | 57 | SYS | Syscoin | `m/44'/57'/0'/0/%d` |
| 133 | 153 | BTM | Bytom | `m/44'/153'/0'/0/%d` |
| 134 | 141 | KMD | Komodo | `m/44'/141'/0'/0/%d` |
| 135 | 44 | PART | Particl | `m/44'/44'/0'/0/%d` |
| 136 | 119 | PIVX | Pivx | `m/44'/119'/0'/0/%d` |
| 137 | 28 | VTC | Vertcoin | `m/44'/28'/0'/0/%d` |
| 138 | 22 | MONA | Monacoin | `m/44'/22'/0'/0/%d` |
| 139 | 17 | GRS | Groestlcoin | `m/84'/17'/0'/0/%d` |
| 140 | 111 | ARK | ARK | `m/44'/111'/0'/0/%d` |
| 141 | 483 | BNT | Bluzelle Native | `m/44'/483'/0'/0/%d` |
| 146 | 178 | POA | Poa | `m/44'/178'/0'/0/%d` |
| 147 | 820 | CLO | Callisto | `m/44'/820'/0'/0/%d` |
| 148 | 550 | XDC | XinFin | `m/44'/550'/0'/0/%d` |
| 149 | 889 | TOMO | TOMO | `m/44'/889'/0'/0/%d` |
| 150 | 5718350 | WAN | Wanchain | `m/44'/5718350'/0'/0/%d` |
| 151 | 108 | UBQ | Ubiq | `m/44'/108'/0'/0/%d` |
| 152 | 1313114 | ETHO | Etho Protocol | `m/44'/1313114'/0'/0/%d` |
| 153 | 184 | MUSIC | Musicoin | `m/44'/184'/0'/0/%d` |
| 154 | 163 | ELLA | Ellaism | `m/44'/163'/0'/0/%d` |
| 155 | 40 | EXP | Expanse | `m/44'/40'/0'/0/%d` |
| 156 | 198 | BAN | Banano | `m/44'/198'/0'/0/%d` |
| 157 | 5353 | HNS | Handshake | `m/44'/5353'/0'/0/%d` |
| 158 | 1533 | BEAM | Beam | `m/44'/1533'/0'/0/%d` |
| 159 | 592 | GRIN | Grin | `m/44'/592'/0'/0/%d` |
| 160 | 140 | LBC | LBRY Credits | `m/44'/140'/0'/0/%d` |
| 161 | 101 | GAME | GameCredits | `m/44'/101'/0'/0/%d` |
| 162 | 135 | STEEM | Steem | `m/44'/135'/0'/0/%d` |
| 163 | 3054 | HIVE | Hive Blockchain | `m/44'/3054'/0'/0/%d` |
| 165 | 43 | XEM | NEM | `m/44'/43'/0'/0/%d` |
| 166 | 137 | RBTC | Rootstock | `m/44'/137'/0'/0/%d` |

## Long tail — 1324 chains not in top-150

Micro-caps, dormant / delisted projects, unissued reservations, or chains
whose tickers we cannot match confidently. Listed in coin_type order.
